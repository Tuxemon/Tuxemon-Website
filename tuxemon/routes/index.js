...
router.get("/windows-install.html", function (req, res) {
  res.render("pages/windows-install", {
    title: "Tuxemon | Windows Install",
    page_name: "windows",
  });
});
...
router.get("/linux-install.html", function (req, res) {
  res.render("pages/linux-install", {
    title: "Tuxemon | Linux Install",
    page_name: "linux",
  });
});

router.get("/ubuntu-install.html", function (req, res) {
  res.render("pages/ubuntu-install", {
    title: "Tuxemon | Ubuntu Install",
    page_name: "linux",
  });
});

router.get("/fedora-install.html", function (req, res) {
  res.render("pages/fedora-install", {
    title: "Tuxemon | Fedora Install",
    page_name: "linux",
  });
});

router.get("/arch-install.html", function (req, res) {
  res.render("pages/arch-install", {
    title: "Tuxemon | Arch Linux Install",
    page_name: "linux",
  });
});

router.get("/mac-install.html", function (req, res) {
  res.render("pages/mac-install", {
    title: "Tuxemon | Mac OS X Install",
    page_name: "mac",
  });
});

router.get("/android-install.html", function (req, res) {
  res.render("pages/android-install", {
    title: "Tuxemon | Android Install",
    page_name: "android",
  });
});

router.get("/gcwzero-install.html", function (req, res) {
  res.render("pages/gcwzero-install", {
    title: "Tuxemon | GCW Zero Install",
    page_name: "gcw",
  });
});
